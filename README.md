...
**Автодеплой:** из корня репозитория выполнить `./deploy.sh` — скрипт соберёт webapp, закоммитит изменения и отправит в `main`; Railway задеплоит по пушу. Опционально: `./deploy.sh "Ваше сообщение коммита"`.
