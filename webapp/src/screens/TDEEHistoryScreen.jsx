      ...
      <div className="relative z-10 flex-1 min-h-0 p-5 safe-top-lg overflow-y-auto">
        ...
        <div className="mb-6">
          <button
            ...
            className="w-full px-8 py-4 rounded-xl bg-white/15 hover:bg-white/25 transition-all text-lg font-bebas tracking-wider text-white"
          >
            Calculate new TDEE plan
          </button>
        </div>
          ...
          <div className="space-y-3">
            {history.map((item) => (
              <div
                ...
                style={{ 
                  background: 'rgba(255,255,255,0.02025)',
                  height: '140px',
                  display: 'grid',
