...
export function ErrorScreen({ message = 'Something went wrong', onRetry, onBack, overlay = 'bg-black/70', image }) {
  return (
    <ScreenLayout overlay={overlay} image={image} onBack={onBack}>
